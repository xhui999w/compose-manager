...
export function ImagesPage() {
  ...
  const columns: ColumnsType<ImageReference> = [
    ...
    { title: '更新', dataIndex: 'updateStatus', width: 104, render: (value) => value === 'available' ? <Tag color="gold">有更新</Tag> : value === 'current' ? <Tag color="green">最新</Tag> : <Tag>等待自动检查</Tag> },
