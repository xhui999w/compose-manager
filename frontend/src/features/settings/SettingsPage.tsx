...
const defaults: SettingsValues = { dockerHost: 'unix:///var/run/docker.sock', composeRoots: '/compose', nasIP: '192.168.1.100', defaultScheme: 'http', externalURL: '', proxyURL: '', operationTimeoutMinutes: 15, density: 'compact' }
